...
The first question to address is: why? Why use a cspilot repository like this? Why make a Python package at all, as opposed to writing custom scripts or Jupyter Notebooks?
...
This is by no means the only cspilot of its kind. Some alternatives include:
...
- [python-package-cspilot](https://github.com/microsoft/python-package-cspilot)

... and many more.

Feel free to use them if you wish! This cspilot repository exists because we are all opinionated people, and this cspilot focuses on things that I value most. But the point is to just use something that works well for you.
